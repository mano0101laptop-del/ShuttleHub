@extends('layout.app')
@section('title', 'New Daily Assignment — Shuttle Hub')
@section('content')
<div class="screen active" id="screen-app">
  @include('partials.sidebar')
  <div class="main">
    <x-topbar title="New Daily Assignment">
      <a href="{{ route('daily-assignments.index', ['date' => $date->toDateString()]) }}" class="btn btn-S"><i class="fas fa-arrow-left"></i> Back</a>
    </x-topbar>
    <div class="content">
      <div class="card" style="max-width:1100px;margin:0 auto 18px;">
        ...
        <div class="card-body">
          <form method="GET" action="{{ route('daily-assignments.create') }}" style="display:grid;grid-template-columns:minmax(180px,.7fr) minmax(260px,1.7fr);gap:14px;align-items:end;">
      ...
      @if($selectedRoute)
        <div class="card" style="max-width:1100px;margin:0 auto;">
          <div class="card-header"><h3><i class="fas fa-calendar-check" style="color:var(--color-success);margin-right:7px;"></i>2. Driver, Bus, Stops, Students & Timings</h3></div>
          <div class="card-body">
