@extends('layout.app')
@section('title', 'Add Vehicle — TM Service')
@section('content')
          ...
          <form method="POST" action="{{ route('vehicles.store') }}">
            ...
            <div class="lf-group">
              ...
              <div class="lf-input-wrap">
                ...
                <input class="lf-input" type="text" name="number" value="{{ old('number') }}" placeholder="e.g. Bus-01" required>
              </div>
            </div>
            <div class="lf-group">
              ...
              <div class="lf-input-wrap">
                ...
                <input class="lf-input" type="text" name="type" value="{{ old('type') }}" placeholder="e.g. Mini Bus, Coach" required>
              </div>
            </div>
            <div class="lf-group">
              ...
              <div class="lf-input-wrap">
                ...
                <input class="lf-input" type="number" name="capacity" value="{{ old('capacity', 30) }}" min="1" required>
              </div>
            </div>
            <div class="lf-group">
