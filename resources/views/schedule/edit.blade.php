...
<div class="screen active" id="screen-app">
  ...
  <div class="main">
    <x-topbar title="Edit Schedule">
      <a href="{{ route('schedule.index', ['date' => $assignment->date->toDateString()]) }}" class="btn btn-S"><i class="fas fa-arrow-left"></i> Back</a>
    </x-topbar>
    <div class="content">
      <div class="card" style="max-width:1100px;margin:0 auto 16px;">
        ...
        <div class="card-body">
          <form method="GET" action="{{ route('schedule.edit', $assignment) }}">
